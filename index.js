...
<<<<<<< HEAD
    window.alert("clicked on development container");
  })
  ...
  // var str2 = "this is a string but cool one";
  // // Number
  // var num1 = 30;
  // var num2 = 34;
  // //Objects
  ...
  // let myArr = ["fan", "chair", 44, null, true];
  // // myArr.pop();
  // // myArr.shift();
  
  // // myArr.push("aditya");
  
  // let newLen=myArr.unshift("aditya");
  // console.log(newLen);
  // console.log(myArr);
  
  // let myStr="aditya dubey"
  // // console.log(myStr.length);
  // // console.log(myStr.indexOf("dubey"));
...
>>>>>>> 56e5329f89c42213295464773a7f6c0ee2970422
